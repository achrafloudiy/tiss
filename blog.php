      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-6 col-lg-4 mb-5">
            <a href="blog-single.php"><img src="images/sq_img_1.jpg" alt="Free Website Template by Free-Template.co"
          ...
          <div class="col-md-6 col-lg-4 mb-5">
            <a href="blog-single.php"><img src="images/sq_img_2.jpg" alt="Free Website Template by Free-Template.co"
                class="img-fluid rounded mb-4"></a>
            <h3><a href="blog-single.php" class="text-black">How to Write a Creative Cover Letter</a></h3>
            <div>April 15, 2019 <span class="mx-2">|</span> <a href="#">2 Comments</a></div>
          </div>
          <div class="col-md-6 col-lg-4 mb-5">
            <a href="blog-single.php"><img src="images/sq_img_3.jpg" alt="Free Website Template by Free-Template.co"
                class="img-fluid rounded mb-4"></a>
            <h3><a href="blog-single.php" class="text-black">The Right Way to Quit a Job You Started</a></h3>
            <div>April 15, 2019 <span class="mx-2">|</span> <a href="#">2 Comments</a></div>
          </div>
          <div class="col-md-6 col-lg-4 mb-5">
            <a href="blog-single.php"><img src="images/sq_img_4.jpg" alt="Free Website Template by Free-Template.co"
                class="img-fluid rounded mb-4"></a>
            <h3><a href="blog-single.php" class="text-black">7 Factors for Choosing Between Two Jobs</a></h3>
            <div>April 15, 2019 <span class="mx-2">|</span> <a href="#">2 Comments</a></div>
          </div>
